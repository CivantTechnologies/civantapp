-- Civant QA Pack: External Signals IE (Funding via CKAN)
-- Connector: ckan_ie_dataportal
...
where tenant_id = :'tenant_id'
  and signal_type = 'funding'
  and signal_source = 'ckan_ie_dataportal'
group by 1
order by rows desc;
