...
import { assertInternalRequest } from './internalOnly.ts';
...
// Process tenant-scoped alerts and send email notifications for matching tenders.
Deno.serve(async (req) => {
    try {
        assertInternalRequest(req, 'processAlerts');
