-- =============================================================================
-- Civant: Predictive engine structural score from value stability
-- Migration: 20260223_predictive_structural_score_value_stability_v1.sql
-- =============================================================================
-- Change:
--   compute_prediction_for_pair_v1 now derives structural_score from
--   buyer_category_stats.value_stability_score instead of framework_expiry_proximity.
--
-- Formula:
--   structural_score = round(10 * value_stability_score), clamped to [0,10]
--
