-- =============================================================================
-- Civant: Ensure grant_awarded contributes to external timing signals
-- Migration: 20260223_predictive_include_grant_awarded_external_v1.sql
-- =============================================================================
-- Goal:
--   Ensure public.compute_prediction_for_pair_v1 includes 'grant_awarded' in the
--   external signal_type set used to compute v_effective_external and
--   v_external_count.
--
-- Notes:
--   - Scoring caps unchanged.
--   - This is a defensive re-application of the current function body.
-- =============================================================================
...
--   count(*) as total,
--   round(100.0 * count(*) filter (where ps.external_signal_score > 0) / nullif(count(*), 0), 4) as with_external_pct
